...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		hdc_draw_Mathematical_curve_2052316();
		to_be_continued("数学曲线- 2052316 李祎娜 -完成", STL_X, STL_Y);
	}
	...
	if (test_choise[T_CUSTOM] == '1') {
		...
		hdc_draw_catoon_2052316(400, 400);
		to_be_continued("卡通图形绘制-2052316李祎娜-完成", STL_X, STL_Y);
